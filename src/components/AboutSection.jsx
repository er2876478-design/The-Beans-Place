...
const values = [
    {
        ...
        title:"Direct Trade Origins",
        description:
            "We partner directly with small farms in Ethiopia, Colombia, Guatemala, and Indonesia. Every bag is full traceable to the farm is came from.",
    },
    {
        icon:"☕",
        title:"Small-Batch Roasting",
            ...
            <div className="about-story-grid">
                ...
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    <p className="about-body lead--light">
                        The Beans Place started in 2012 with one simple belief; great 
                        coffee should be accessible to everyone- not just aficionados. We 
                        work directly with farming cooperatives across four continents,
                        paying above fair-trade prices to ensure quality from soil to 
                        sip.
                    </p>
                    ...
                    <p className="about-body lead--light">
                        ...
                        fruity Ethiopian Yirgacheffe or a deep, chocolately Colombian 
                        Supremo, we roast each batch to order so it arrvies at peak
                        freshness. 
                    </p>               
                </ScrollReveal>
