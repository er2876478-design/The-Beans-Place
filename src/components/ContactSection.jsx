...
function TiltCard( { children, className, href, target, rel } ) {
    ...
    const rotateX = useSpring(useTransform(y, [-0.5, 0.5], [6,-6]), {stiffness: 200,
    damping: 20 } );
    const rotateY = useSpring(useTransform(x, [-0.5, 0.5], [-6,6]), {stiffness: 200,
    damping: 20 } );
        ...
        >
            ...
            <div className="mt-4">
                <Textarea 
                    ...
                    onChange={handleChange}
                    onBlue={handleBlur}
                    error={ touched.message && !formData.message ? "Message is required"
                    : undefined }
                />
            </div>
